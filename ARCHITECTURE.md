...
> Last updated: 2026-03-29 by doc-freshness agent
...
| `retrieval-signals` | ~137 | Query logging and retrieval signal tracking (latency, strategy, arm, propensity) |
| `timeline` | ~111 | Agent timeline management — date-anchored chapters, arcs, events, and decisions |

...
-- 3. Partial unique index for agent_id (NULL rows excluded to avoid false conflicts)
CREATE UNIQUE INDEX pool_grants_pool_id_agent_id_key ON pool_grants(pool_id, agent_id) WHERE agent_id IS NOT NULL;

  ...
  async extract(
    ...
    try {
      ...
      const extractionResult: ExtractionResult = {
        who: typeof result.who === 'string' ? result.who || null : Array.isArray(result.who) ? result.who.join(', ') || null : null,
        what: typeof result.what === 'string' ? result.what || null : null,
        when: typeof result.when === 'string' ? result.when || null : null,
        where: typeof result.where === 'string' ? result.where || null : Array.isArray(result.where) ? result.where.join(', ') || null : null,

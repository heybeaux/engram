...
import { MemoryWithExtraction, ContextResult } from './memory.types';

/**
 * Context loading, budget selection, and formatting for MemoryQueryService.
 *
...
export class MemoryQueryContextService {
  ...
  /**
   * Format memories into a context string within a token budget.
   */
  formatContext(
    memories: Memory[],
    maxTokens: number,
